...
def init_auth(app, database, oauth_model, user_model):
    global login_manager, replit_bp, db, OAuth, User
    db = database
    OAuth = oauth_model
    User = user_model
    ...
    replit_bp = make_replit_blueprint(app)
...
def save_user(user_claims):
    from models import DEFAULT_TOKEN_BALANCE
